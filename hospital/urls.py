...
urlpatterns = [
    ...
    path('predict/<int:patient_id>/', views.predict, name='repredict'),
    path('prediction-history/<int:patient_id>/', views.view_prediction_history, name='prediction_history'),
    ...
    path('process-assignment/', views.process_bed_assignment, name='process_bed_assignment'),
    ...
    # Cross-hospital referral view
    path('cross-hospital/', views.cross_hospital_availability, name='cross_hospital_availability'),
